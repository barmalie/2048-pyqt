...
class ui(QWidget):
    ...
    def initUI(self):
        ...
        self.setToolTip("Игра, направленная на получение числа 2048")
        ...
        self.x, ok = QInputDialog.getInt(self, "Поле ввода",
                                         "Пожалуйста, введите количество квадратов в каждой строке:", 4, 4, 8, 1)

        QMessageBox.information(self, "Подсказка",
                                "Пожалуйста, нажимайте клавиши со стрелками для работы. Вам нужно получить номер 1024, чтобы выиграть!")
    ...
    def label_generator(self):
        ...
        self.lb_inv = 5  # количество пикселей между двумя соседними QLabel
        ...
        for i in range(self.x):
            for j in range(self.x):
                ...
                lb[i][j].setGeometry(15 + (self.lb_width + self.lb_inv) * j, 15 + (self.lb_height + self.lb_inv) * i,
                                     self.lb_width, self.lb_height)
